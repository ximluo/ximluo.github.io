...
const GradientBackground: React.FC<GradientBackgroundProps> = ({ theme, children }) => {
  ...
  const gradients = {
    bunny: {
      colors: [
        { offset: 0, color: 'rgba(249, 240, 251, 1)' },
        { offset: 0.5, color: 'rgba(255, 230, 250, 1)' },
        { offset: 1, color: 'rgba(244, 226, 246, 1)' }
      ],
      direction: { x: 0, y: 1 }
    },
    water: {
      colors: [
        { offset: 0, color: 'rgba(99, 33, 238, 1)' },
        { offset: 0.5, color: 'rgba(120, 50, 255, 1)' },
        { offset: 1, color: 'rgba(80, 20, 200, 1)' }
      ],
      direction: { x: 1, y: 0 }
    }
  };
